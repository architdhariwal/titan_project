...
describe('Filter Component', () => {
  ...
  it('renders filter options correctly', () => {
    render(<Filter onFilterChange={mockOnFilterChange} selectedFilter="" onSortChange={mockOnSortChange} />);
  ...
  it('shows clear filter button when a filter is selected', () => {
    render(<Filter onFilterChange={mockOnFilterChange} selectedFilter="men" onSortChange={mockOnSortChange} />);
  ...
  it('calls onSortChange when sort option is changed', () => {
    ...
    fireEvent.change(screen.getByRole('combobox'), { target: { value: 'highToLow' } });
